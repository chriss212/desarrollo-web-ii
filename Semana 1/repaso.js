const data = [
  ...
  const copyBook = {...book}
  const extendedBook = {...book, editorial: 'Clásicos Roxsil'}
  console.log(extendedBook)

  // operador condcional y template strings
  ...
  const booksAfterUpdate = [booksAfterDelete.filter(book => book.id !== 10), 
